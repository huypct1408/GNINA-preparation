...
Cach sua
```
rm "$CONDA_PREFIX/etc/conda/activate.d/gnina_ld.sh"  rm "$CONDA_PREFIX/etc/conda/deactivate.d/gnina_ld.sh"
printf 'set -gx LD_LIBRARY_PATH "$CONDA_PREFIX/lib"\n' > "$CONDA_PREFIX/etc/conda/activate.d/gnina_ld.fish"

󰕈 labhhc5  …/workspace/D21/Duong Huy  🅒  gnina_env   17:36  
 conda list | grep -i nvtx
cuda-nvtx                 12.1.105                      0    nvidia

󰕈 labhhc5  …/workspace/D21/Duong Huy  🅒  gnina_env   17:36  
 conda list | grep -i nvtool
...
bash: /home/labhhc5/miniconda3/lib/libtinfo.so.6: no version information available (required by bash)
/home/labhhc5/miniconda3/lib

󰕈 labhhc5  …/workspace/D21/Duong Huy  🅒  gnina_env   17:37  
 set -gx LD_LIBRARY_PATH "$CONDA_PREFIX/lib"

󰕈 labhhc5  …/workspace/D21/Duong Huy  🅒  gnina_env   17:38  
 ldd '/home/labhhc5/Documents/workspace/D21/Duong Huy/gnina_project/bin/gnina' | grep "not found"
...
󰕈 labhhc5  …/workspace/D21/Duong Huy  🅒  gnina_env   17:39  
 rm "$CONDA_PREFIX/etc/conda/activate.d/gnina_ld.sh"
  rm "$CONDA_PREFIX/etc/conda/deactivate.d/gnina_ld.sh"
...
󰕈 labhhc5  …/workspace/D21/Duong Huy  🅒  base   17:40  
 conda activate gnina_env

󰕈 labhhc5  …/workspace/D21/Duong Huy  🅒  gnina_env   17:40  
 '/home/labhhc5/Documents/workspace/D21/Duong Huy/gnina_project/bin/gnina' --help
...
Information (optional):
  ...
  --version                          display program version
```
# ✅ GNINA đã hoạt động hoàn hảo! 🎉

Mọi thứ đã được cài đặt và cấu hình xong.

## Từ nay về sau, mỗi khi mở terminal mới, chỉ cần 2 lệnh:

```fish
conda activate gnina_env
'/home/labhhc5/Documents/workspace/D21/Duong Huy/gnina_project/bin/gnina' [các tùy chọn]
```
...
'/home/labhhc5/Documents/workspace/D21/Duong Huy/gnina_project/bin/gnina' \
  -r receptor.pdbqt \
  -l ligand.sdf \
...
| Bước | Nội dung |
|---|---|
| 1 | Tải gnina binary vào `gnina_project/bin/` |
| 2 | Tạo conda env `gnina_env` với CUDA + cuDNN + nvtx |
| 3 | Tạo fish hook tự động set `LD_LIBRARY_PATH` khi activate |
| 4 | ✅ gnina chạy thành công |

**Bạn đã sẵn sàng để docking!** 🚀
